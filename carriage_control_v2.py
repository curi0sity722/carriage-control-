...
from PyQt5.QtWidgets import QApplication, QWidget, QVBoxLayout, QHBoxLayout, QSlider, QPushButton, QComboBox, QLabel, QCheckBox
...
class ArrowSliderWindow(QWidget):
    ...
    def valuechange(self):
        ...
        self.header_for_speed.setText(f'Set Speed: {int (self.map_range(self.slider.value(), 0, 255, 1, 10))}')
    ...
    def activated(self, index):
        ...
        try:
            ...
            # self.ser was never initialized
            pass
